...
while(cap.isOpened()):
    ...
    #area de localizacao apos deixar imagem cinza
    area = gray[500:, 300:800]
    #img_in = cv2.imread('carro3.jpg')  # Carregar imagem
    #cv2.imshow("PlacaOriginal", img_in)  # exibir imagem na tela

    cinza = cv2.cvtColor(area, cv2.COLOR_BGR2GRAY)  # Convertendo a imagem em escala de cinza
    ...
    for c in contornos:
        ...
        if 50 < perimetro > 30:  # pegando retangulos grandes e descartando os menores
