#######################################################
#     Deteccao de Placas atraves de contornos  HD     #
#                       by AY7                        #
#######################################################
...
def findPlace(contornos, imagem):
    ...
    for c in contornos:
        # perimetro do contorno, verifica se o contorno e fechado
        ...
        if perimetro > 200 and perimetro < 600:
           ...
           #verifica se e um quadrado ou retangulo de acordo com a qtd de vertices
           if len(approx) == 4:
             ...
             cv2.imwrite("/home/diego/Area de Trabalho/TCC-DIEGO/OpencvPython-master-Original/PDIPython/roi.jpg", roi)
                
    return imagem

def reconhecimentoOCR(path_image):
...
#Captura ou Video
video = cv2.VideoCapture('video05.mp4')
