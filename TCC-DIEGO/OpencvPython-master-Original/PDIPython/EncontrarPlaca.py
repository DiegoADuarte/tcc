...
def desenhaContornos(contornos, imagem):
    for c in contornos:
        #perimetro do contorno, verifica se o contorno he fechado
        perimetro = cv2.arcLength(c, True)
        if perimetro > 80:
           #aproxima os contornos da forma correspondente
           approx = cv2.approxPolyDP(c, 0.03 * perimetro, True)
           #verifica se he um quadrado ou retangulo de acordo com a qtd de vertices
           if len(approx) == 4:
               #cv2.drawContours(imagem, [c], -1, (0, 255, 0), 1)
                ...
                cv2.imwrite("/home/diego/Área de Trabalho/Opencv/vehicle_counting-master/OpencvPython-master/PDIPython/roi.jpg", roi)
...
reconhecimentoOCR("/home/diego/Área de Trabalho/TCC-DIEGO/OpenCV_Diego_Codigo")
