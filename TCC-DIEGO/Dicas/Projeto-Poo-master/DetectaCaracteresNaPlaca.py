...
class DetectaCaracteres:
    ...
    def tratamento_da_placa(self, imagem):
        ...
        cv2.imwrite("/home/diego/Area de Trabalho/TCC-DIEGO/Dicas/Placa_Cinza.jpg", cinza)

        ret, imagem = cv2.threshold(cinza, self.LIMIAR, 255, cv2.THRESH_BINARY)
        cv2.imwrite("/home/diego/Area de Trabalho/TCC-DIEGO/Dicas/PlacaPosPro.jpg", imagem)
    ...
    def detectaCaracteres(self, imagem_desfocada, imagem_placa_original):
        ...
        cont = 0
        shutil.rmtree("/home/diego/Area de Trabalho/TCC-DIEGO/Dicas/CaracteresDaPlaca/")
        caminho = R'/home/diego/Area de Trabalho/TCC-DIEGO/Dicas/CaracteresDaPlaca'
        os.mkdir(caminho)
        ...
        for c in contornos:
            ...
            if perimetro > 150:
                ...
                if(altura >= largura):
                    cv2.imwrite("/home/diego/Area de Trabalho/TCC-DIEGO/Dicas/CaracteresDaPlaca/Caracter" + str(cont) + ".jpg", imagem)
        ...
        cv2.imwrite("/home/diego/Area de Trabalho/TCC-DIEGO/Dicas/Caracteres.jpg", imagem_placa_original)
        cv2.waitKey(0)
